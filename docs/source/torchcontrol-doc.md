...
- A torch-scriptable rotation and transformation library similar to [scipy.spatial.transform.Rotation](https://docs.scipy.org/doc/scipy/reference/generated/scipy.spatial.transform.Rotation.html#scipy.spatial.transform.Rotation)
...
When starting to write your own policies, a good place to start is to go through the [built-in policies](https://github.com/fair-robotics/polymetis/tree/main/polymetis/python/torchcontrol/policies) as examples.
...
(Note that quaternions are expressed in the XYZW format.)
